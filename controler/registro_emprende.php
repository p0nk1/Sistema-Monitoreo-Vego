...
//Campos que van hacia la tabla planes_personas
	$plan= 4;// el numero 1 pertenece a el plan EMPRENDIMIENTO para saber que ID corresponde a caba plan consulten la tabla planes
	$hoy = date("j- n-Y");
/************************************************/
			...
			$sql="INSERT INTO personas (cedula,nombre,apellido,sexo,f_nacimiento) VALUES ('$cedula','$nombre','$apellido','$sexo','$f_nacimiento') RETURNING cedula";
				$query=pg_query($conexion,$sql);
					if ($query) {	
							...
							$sql5="INSERT INTO laboral (grado_instruccion,profesion_oficio,trabaja,id_persona_laboral) VALUES ('$g_instruccion','$profesion','NO APLICA',$id)";
							...
							if ($query10) {
								/*$mail = new PHPMailer(true);
									...
									$mail->Subject = 'Registro en el Proyecto Emprende';
									$mail->Body    = 'Felicidades su registro en el Proyecto Emprende  fue Exitoso en los proximos dias sera contactado por nuestro Personal " Por la  Soberania  Juntos Podemos"';
									$mail->send();
								...
								echo '  <script type="text/javascript">
											alert("Su Registro en el Proyecto Emprende fue Completado con Exito");
