...
//Campos que van hacia la tabla planes_personas
	$plan=3;// el numero 1 pertenece a el plan BRIGADAS TECNICAS ESPECIALIZADAS para saber que ID corresponde a caba plan consulten la tabla planes
	$hoy = $hoy = date("j- n-Y");
/************************************************/
	$r_social   =  strtoupper($_POST['r_social']);
/************************************************/
	$brigada_p     =  $_POST['brigada_p'];
/*************************************************//*/
			...
			$sql="INSERT INTO personas (cedula,nombre,apellido,sexo,f_nacimiento) VALUES ('$cedula','$nombre','$apellido','$sexo','$f_nacimiento') RETURNING cedula";
				$query=pg_query($conexion,$sql);
					if ($query) {	
							...
							$sql8="INSERT INTO brigadas_persona (brigadas,id_persona_brigada) VALUES ('$brigada_p','$id')";
