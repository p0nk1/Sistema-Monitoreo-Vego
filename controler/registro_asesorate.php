...
//Campos que van hacia la tabla planes_personas
	$plan=2;// el numero 2 pertenece a el plan ASESORATE agroalimentarias para saber que ID corresponde a caba plan consulten la tabla planes
	$hoy = date("j- n-Y");
/************************************************/
			...
			$sql="INSERT INTO personas (cedula,nombre,apellido,sexo,f_nacimiento) VALUES ('$cedula','$nombre','$apellido','$sexo','$f_nacimiento') RETURNING cedula";
				$query=pg_query($conexion,$sql);
					if ($query) {	
							...
							$sql8="INSERT INTO solicitud (t_asesoramiento,t_solicitud,id_persona_solicitud) VALUES ('$t_ase','$solictud','$id')";
								$query8=pg_query($sql8);
							$sql9= "INSERT INTO produccion (produce,nivel,id_persona_produccion,esp_productivo) VALUES ('$e_produccion','$n_produccion','$id','NO APLICA')";	
