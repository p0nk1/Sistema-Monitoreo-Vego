...
/*******************************************************************************************************************************/ 
    ...
    var sexo = [f,m];
/*********************************************************************************************************************************/      
    var proyectos = ['Servicios','procesamiento Alimentos','Produccion Vegetal','Produccion Animal','Higiene','Licores','Hidrico','Refrigeracion'];
    var valor = [industrial,tecnologico,p_alimenticio,administrativo,p_electrico,p_refrigeracion,p_petroquimico,p_refrigeracion];
/************************************************************************************************************************************/     
</script>
  <section class="content">
     <div class="block-header">
                <h2>Graficas Estadisticas Programa Joven Emprendedor</h2>
            </div>
