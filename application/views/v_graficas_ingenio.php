...
/*******************************************************************************************************************************/ 
    ...
    var sexo = [f,m];
/*********************************************************************************************************************************/      
    var proyectos = ['Industrial','Tecnologico','Alimienticio','Administrativa','Electrico','Refrigeracion','Petroquimico','Hidraulica','Automotriz'];
    var valor = [industrial,tecnologico,p_alimenticio,administrativo,p_electrico,p_refrigeracion,p_petroquimico,p_hidraulica,p_atomotriz];
/************************************************************************************************************************************/     
</script>
  <section class="content">
       <div class="block-header">
                <h2>Graficas Estadisticas del Proyecto Ingenio</h2>
            </div>
                        ...
                        <canvas id="myChart3" width="200" height="200"></canvas>
                            ...
                            var myChart2 = new Chart(ctx, {
                                ...
                                data: {
                                    labels: proyectos ,
                                    datasets: [{
                                        label: ' Grafico N° 3 Tipo de Tecnologia u Emprendimiento',
                                        data: valor,
                                        backgroundColor: [
                                            'rgba(255, 99, 132, 0.5)',
                                            'rgba(54, 162, 235, 0.5)',
