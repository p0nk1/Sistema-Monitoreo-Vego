<?php
class M_gf_asesorate extends CI_Model
{
    function _construct(){
        parent::__construct(); 
    }   
 /*********************************************************Grafica Genero******************************************************************/    
  ...
  $this->db->where("personas.id_persona = planes_personas.key_id_personas AND planes_personas.key_id_planes='2' AND  personas.sexo='F'");
  $aragua = $this->db->get();
  ...
  $this->db->query("SELECT count ('*')");
  $this->db->from('public.personas, public.planes_personas');
  $this->db->where("personas.id_persona = planes_personas.key_id_personas AND planes_personas.key_id_planes='2' AND  personas.sexo='M'");
  $aragua = $this->db->get();
    return $aragua->result();
 }   
...
public function p_industrial(){
  ...
  public.solicitud');
      $this->db->where(" solicitud.id_persona_solicitud = planes_personas.key_id_personas AND planes_personas.key_id_planes='2' AND solicitud.t_asesoramiento='LEGAL' ");
        $aragua = $this->db->get();
 ...
 public function p_alimenticio(){
     $this->db->query("SELECT COUNT ('*')");
      $this->db->from('public.planes_personas, 
  public.solicitud');
      $this->db->where(" solicitud.id_persona_solicitud = planes_personas.key_id_personas AND planes_personas.key_id_planes='2' AND solicitud.t_asesoramiento='TECNICA' ");
        $aragua = $this->db->get();
  ...
  public function p_administrativo(){
      ...
      $this->db->from('public.planes_personas, 
  public.solicitud');
      $this->db->where(" solicitud.id_persona_solicitud = planes_personas.key_id_personas AND planes_personas.key_id_planes='2' AND solicitud.t_asesoramiento='ADMISNISTRATIVA' ");
        $aragua = $this->db->get();
        return $aragua->result();
 }
...
public function lista_personal(){
      ...
      $this->db->where("planes_personas.key_id_personas = figura_juridica.id_persona_figura AND figura_juridica.r_social = 'PERSONAL' AND planes_personas.key_id_planes='2'");
        $aragua = $this->db->get();
        return $aragua->result();
 }
 public function lista_upf(){
  $this->db->query("SELECT COUNT ('*')");
      $this->db->from(' public.planes_personas, public.figura_juridica');
      $this->db->where("planes_personas.key_id_personas = figura_juridica.id_persona_figura AND figura_juridica.r_social = 'UPF' AND planes_personas.key_id_planes='2'");
        $aragua = $this->db->get();
        return $aragua->result();
  $aragua = $this->db->get();
    return $aragua->result();
...
public function lista_eps(){
  $this->db->query("SELECT COUNT ('*')");
      $this->db->from(' public.planes_personas, public.figura_juridica');
      $this->db->where("planes_personas.key_id_personas = figura_juridica.id_persona_figura AND figura_juridica.r_social = 'EPS' AND planes_personas.key_id_planes='2'");
        $aragua = $this->db->get();
        return $aragua->result();
 }
 public function lista_coop(){
  $this->db->query("SELECT COUNT ('*')");
      $this->db->from(' public.planes_personas, public.figura_juridica');
      $this->db->where("planes_personas.key_id_personas = figura_juridica.id_persona_figura AND figura_juridica.r_social = 'COOPERATIVA' AND planes_personas.key_id_planes='2'");
        $aragua = $this->db->get();
        return $aragua->result();
  $aragua = $this->db->get();
    return $aragua->result();
 ...
 public function lista_ca(){
  $this->db->query("SELECT COUNT ('*')");
      $this->db->from(' public.planes_personas, public.figura_juridica');
      $this->db->where("planes_personas.key_id_personas = figura_juridica.id_persona_figura AND figura_juridica.r_social = 'COMPAÑIA ANONIMA' AND planes_personas.key_id_planes='2'");
        $aragua = $this->db->get();
        return $aragua->result();
 }
