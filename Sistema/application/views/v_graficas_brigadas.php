...
/************************************************************************************/
    ...
    var p_infraestructura  = "<?php echo  $p_infraestructura  = count($p_infraestructura)?>";
</script>
<script > 
...
/*******************************************************************************************************************************/ 
    ...
    var sexo = [f,m];
/*********************************************************************************************************************************/     
// ,administrativo,p_electrico,p_refrigeracion,p_refrigeracion
//,,'Hidraulica'
    var proyectos = ['Electrica','Agro Alimentaria','Refrigeracion','Hidraulica','Automotriz','Mecanica','Petroquimica','Petrolera','Infraestructura'];
    var valor      = [industrial,tecnologico,p_alimenticio,administrativo,p_atomotriz,p_electrico,p_refrigeracion,p_petroquimico,p_infraestructura];
/************************************************************************************************************************************/     
</script>
  <section class="content">
    <div class="block-header">
                <h2>Graficas Estadisticas de las  Brigadas Tecnicas de Acompañamiento</h2>
            </div>
                        ...
                        <canvas id="myChart3" width="200" height="200"></canvas>
                            ...
                            var myChart2 = new Chart(ctx, {
                                ...
                                data: {
                                    labels: proyectos ,
                                    datasets: [{
                                        label: ' Grafico N° 3 Tipo de Brigadas',
                                        data: valor,
                                        backgroundColor: [
                                            'rgba(255, 99, 132, 0.5)',
                                            'rgba(54, 162, 235, 0.5)',
